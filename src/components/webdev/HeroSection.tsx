...
import { Sparkles, Zap, Search, Palette } from "lucide-react";
...
const ROTATING = ["Startups", "SaaS", "E-Commerce", "Enterprises", "Agencies", "Nonprofits"];

export default function HeroSection({
  serviceName = "Website Development",
  bgAltImage = "/images/webdev.png",
}: HeroSectionProps) {
        ...
        <div className="mx-auto w-full max-w-[1280px] lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
          ...
          >
            ...
            <h2 className="mt-2 text-[18px] sm:text-xl md:text-3xl lg:text-4xl text-white font-semibold">
              Fast, Scalable, and SEO-Ready Websites
            </h2>

            {/* 2 paragraphs */}
            <p className="mt-4 text-[15px] sm:text-base md:text-lg text-white/90 leading-relaxed max-w-[34ch] sm:max-w-[48ch] md:max-w-3xl mx-auto lg:mx-0">
              We build high-performance websites that balance design, performance, and security — 
              tailored to your brand and optimized for conversions.
            </p>
            <p className="mt-2 text-[15px] sm:text-base md:text-lg text-white/80 leading-relaxed max-w-[34ch] sm:max-w-[48ch] md:max-w-3xl mx-auto lg:mx-0">
              From startups to enterprises, our sites are SEO-friendly, scalable, and deliver 
            ...
            <div className="mt-4 h-6 sm:h-8 md:h-10 overflow-hidden relative">
              <AnimatePresence mode="wait">
                ...
                >
                  Websites that convert for {ROTATING[index]}
                </motion.div>
              </AnimatePresence>
            </div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 md:hidden">
              {[{ title: "Fast & Scalable" }, { title: "SEO Ready" }].map(({ title }) => (
            ...
            <div className="mt-6 hidden md:grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { icon: Zap, title: "Fast & Scalable", desc: "Optimized for Core Web Vitals." },
                { icon: Search, title: "SEO Ready", desc: "Structured data & search visibility." },
